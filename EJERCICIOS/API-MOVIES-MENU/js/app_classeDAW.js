...
const printPelis = (pelicules) => {
    let peliculesHTML = '';
    pelicules.forEach(pelicula => {
        peliculesHTML +=
        `<div class="pelicula" onclick="printDetall(${pelicula.id})">
            <img class="poster" src="${pathImageBase}${pelicula.poster_path}"></img>
