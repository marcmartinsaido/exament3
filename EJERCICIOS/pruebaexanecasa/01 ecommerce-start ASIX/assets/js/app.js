...
// Filtrar por nombre no funciona y ademas no te permite ver nada no se porque no funciona me da un error diciendo que hay que declarar la variable fuera del DOMContentLoaded pero no va

// const btnFiltrarTag = document.getElementById("btnFiltrarTag");
// const textSearchTag = document.getElementById("");
...
// }
  ...
  function init() {
    ...
    // Ejecutar la función init cuando el DOM esté cargado
    init();
});
